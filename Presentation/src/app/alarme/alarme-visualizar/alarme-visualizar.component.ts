...
export class AlarmeVisualizarComponent implements OnInit {
  ...
  constuirSVG(): string {
    ...
    <text fill="#000000" stroke-width="null" stroke-dasharray="null" stroke-opacity="null" fill-opacity="null" opacity="undefined" x="278.28622" y="34.80307" id="svg_15" font-size="28" font-family="'Montserrat Thin'" text-anchor="start" xml:space="preserve" font-weight="normal" font-style="normal">${this.alarme.descricao}</text>
